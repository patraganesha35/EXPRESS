...
export default function PartnerBookingsPage() {
  ...
  useEffect(() => {
    ...
    const handleBookingUpdated = () => {
      fetchBookings(); // Refetch all bookings to get latest status
    };
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <button 
                  ...
                  className="flex items-center gap-2 text-sm font-semibold text-gray-500 hover:text-gray-900 transition-colors mb-4 px-3 py-1.5 bg-gray-100 rounded-lg w-fit"
                >
                  ← Back
                </button>
